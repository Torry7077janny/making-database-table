...
//    process file data
    ...
    $fileExtention = strtolower(end( $fileNameCmps)); //extension of the image

//    allowed extentions for file upload
    $extension = array("jpeg","jpg","png");
    if(in_array($fileExtention, $extension)==false){
//        if user uploads an image with diff extension
    ...
    <div class="row">
        <div class="col-md-8 col-lg-8 col-xl-8">
            ...
            <table class="table table-bordered table-dark">
                ...
                <?php
                $sql= "SELECT `id`, `supplier_id`, `title`, `price`, `description`, `time_posted` FROM `products` WHERE supplier_id='$supplier_id'";
